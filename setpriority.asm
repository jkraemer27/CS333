...
main(int argc, char ** argv)
{
  ...
  1c:	68 14 09 00 00       	push   $0x914
  21:	6a 01                	push   $0x1
  23:	e8 35 05 00 00       	call   55d <printf>
  28:	83 c4 10             	add    $0x10,%esp
	exit();
  2b:	e8 6e 03 00 00       	call   39e <exit>
    }
  ...
  3b:	50                   	push   %eax
  3c:	e8 f8 01 00 00       	call   239 <atoi>
  ...
  52:	50                   	push   %eax
  53:	e8 e1 01 00 00       	call   239 <atoi>
  ...
  67:	e8 12 04 00 00       	call   47e <setpriority>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4f9:	0f b6 80 bc 0b 00 00 	movzbl 0xbbc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 635:	75 25                	jne    65c <printf+0xff>
          s = "(null)";
 637:	c7 45 f4 49 09 00 00 	movl   $0x949,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6fd:	a1 d8 0b 00 00       	mov    0xbd8,%eax
...
free(void *ap)
{
 ...
 7c8:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 7cd:	90                   	nop
 7ce:	c9                   	leave  
 7cf:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 826:	83 c4 10             	add    $0x10,%esp
  return freep;
 829:	a1 d8 0b 00 00       	mov    0xbd8,%eax
}
 82e:	c9                   	leave  
 82f:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 842:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 845:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 84a:	89 45 f0             	mov    %eax,-0x10(%ebp)
 84d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 851:	75 23                	jne    876 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 853:	c7 45 f0 d0 0b 00 00 	movl   $0xbd0,-0x10(%ebp)
 85a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 85d:	a3 d8 0b 00 00       	mov    %eax,0xbd8
 862:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 867:	a3 d0 0b 00 00       	mov    %eax,0xbd0
    base.s.size = 0;
 86c:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 873:	00 00 00 
  }
 ...
 8c9:	a3 d8 0b 00 00       	mov    %eax,0xbd8
      return (void*)(p + 1);
 ...
 8d4:	eb 3b                	jmp    911 <malloc+0xe1>
    ...
    if(p == freep)
 8d6:	a1 d8 0b 00 00       	mov    0xbd8,%eax
