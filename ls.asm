...
fmtname(char *path)
{
 ...
 2e2:	68 6c 12 00 00       	push   $0x126c
 ...
 314:	05 6c 12 00 00       	add    $0x126c,%eax
 ...
 325:	83 c4 10             	add    $0x10,%esp
  return buf;
 328:	b8 6c 12 00 00       	mov    $0x126c,%eax
}
...
#ifdef CS333_P5
      //printf(1, "Mode\t\tFilename\tUID\tGID\tInode\tSize\n");
      print_mode(&st);
...
00000a24 <getprocs>:
SYSCALL(getprocs)
 a24:	b8 1a 00 00 00       	mov    $0x1a,%eax
 a29:	cd 40                	int    $0x40
 a2b:	c3                   	ret    

00000a2c <setpriority>:
SYSCALL(setpriority)
 a2c:	b8 1b 00 00 00       	mov    $0x1b,%eax
 a31:	cd 40                	int    $0x40
 a33:	c3                   	ret    

00000a34 <chmod>:
SYSCALL(chmod)
 a34:	b8 1c 00 00 00       	mov    $0x1c,%eax
 a39:	cd 40                	int    $0x40
 a3b:	c3                   	ret    

00000a3c <chown>:
SYSCALL(chown)
 a3c:	b8 1d 00 00 00       	mov    $0x1d,%eax
 a41:	cd 40                	int    $0x40
 a43:	c3                   	ret    

00000a44 <chgrp>:
SYSCALL(chgrp)
 a44:	b8 1e 00 00 00       	mov    $0x1e,%eax
 a49:	cd 40                	int    $0x40
 a4b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 abf:	0f b6 80 58 12 00 00 	movzbl 0x1258(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 bfb:	75 25                	jne    c22 <printf+0xff>
          s = "(null)";
 bfd:	c7 45 f4 70 0f 00 00 	movl   $0xf70,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 cc3:	a1 84 12 00 00       	mov    0x1284,%eax
...
free(void *ap)
{
 ...
 d8e:	a3 84 12 00 00       	mov    %eax,0x1284
}
 d93:	90                   	nop
 d94:	c9                   	leave  
 d95:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 dec:	83 c4 10             	add    $0x10,%esp
  return freep;
 def:	a1 84 12 00 00       	mov    0x1284,%eax
}
 df4:	c9                   	leave  
 df5:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 e08:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 e0b:	a1 84 12 00 00       	mov    0x1284,%eax
 e10:	89 45 f0             	mov    %eax,-0x10(%ebp)
 e13:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 e17:	75 23                	jne    e3c <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 e19:	c7 45 f0 7c 12 00 00 	movl   $0x127c,-0x10(%ebp)
 e20:	8b 45 f0             	mov    -0x10(%ebp),%eax
 e23:	a3 84 12 00 00       	mov    %eax,0x1284
 e28:	a1 84 12 00 00       	mov    0x1284,%eax
 e2d:	a3 7c 12 00 00       	mov    %eax,0x127c
    base.s.size = 0;
 e32:	c7 05 80 12 00 00 00 	movl   $0x0,0x1280
 e39:	00 00 00 
  }
 ...
 e8f:	a3 84 12 00 00       	mov    %eax,0x1284
      return (void*)(p + 1);
 ...
 e9a:	eb 3b                	jmp    ed7 <malloc+0xe1>
    ...
    if(p == freep)
 e9c:	a1 84 12 00 00       	mov    0x1284,%eax
