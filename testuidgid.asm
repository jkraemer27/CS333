...
printint(int fd, int xx, int base, int sgn)
{
 ...
 563:	0f b6 80 70 0c 00 00 	movzbl 0xc70(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 69f:	75 25                	jne    6c6 <printf+0xff>
          s = "(null)";
 6a1:	c7 45 f4 02 0a 00 00 	movl   $0xa02,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 767:	a1 8c 0c 00 00       	mov    0xc8c,%eax
...
free(void *ap)
{
 ...
 832:	a3 8c 0c 00 00       	mov    %eax,0xc8c
}
 837:	90                   	nop
 838:	c9                   	leave  
 839:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 890:	83 c4 10             	add    $0x10,%esp
  return freep;
 893:	a1 8c 0c 00 00       	mov    0xc8c,%eax
}
 898:	c9                   	leave  
 899:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8ac:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8af:	a1 8c 0c 00 00       	mov    0xc8c,%eax
 8b4:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8b7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8bb:	75 23                	jne    8e0 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8bd:	c7 45 f0 84 0c 00 00 	movl   $0xc84,-0x10(%ebp)
 8c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8c7:	a3 8c 0c 00 00       	mov    %eax,0xc8c
 8cc:	a1 8c 0c 00 00       	mov    0xc8c,%eax
 8d1:	a3 84 0c 00 00       	mov    %eax,0xc84
    base.s.size = 0;
 8d6:	c7 05 88 0c 00 00 00 	movl   $0x0,0xc88
 8dd:	00 00 00 
  }
 ...
 933:	a3 8c 0c 00 00       	mov    %eax,0xc8c
      return (void*)(p + 1);
 ...
 93e:	eb 3b                	jmp    97b <malloc+0xe1>
    ...
    if(p == freep)
 940:	a1 8c 0c 00 00       	mov    0xc8c,%eax
